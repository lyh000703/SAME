...
<head>
    ...
    <style>
        ...
        .photo {
        <%--     width: 100px; /* 증명사진 크기 */
            height: 100px; /* 증명사진 크기 */
            border-radius: 50%; /* 원형으로 만들기 */
            background-color: #D9D9D9; /* 기본 색상 */
            background-image: url('<%= mentor.getProfileImage() %>'); /* 업로드된 사진 */
